...
class FrontControllerCore extends Controller
{
    ...
    public function initFooter()
    {
      ...
      $products = $productObj -> getProducts($this->context->language->id, 0, 0, 'id_product', 'DESC',false,false,null,'GROUP BY `ean13`' );
      echo ("<div id='Products-Information' style='display:none'>");
      foreach ($products as $producto) {
          echo($producto['ean13']);
          echo("|");
          echo($this->context->link->getProductLink($producto));
          echo("\n");
      }
      echo ("</div>");
    }
    ...
    public function setMedia()
    {
        ...
        $this->registerStylesheet('banner-main', '/assets/css/banner-principal.css', ['media' => 'all', 'priority' => 5]);
        $this->registerStylesheet('sign-main', '/assets/css/sign-customer.css', ['media' => 'all', 'priority' => 6]);
        $this->registerStylesheet('footer-main', '/assets/css/footer-main.css', ['media' => 'all', 'priority' => 7]);
        $this->registerStylesheet('cart-main', '/assets/css/cart-page.css', ['media' => 'all', 'priority' => 8]);
        $this->registerStylesheet('buy-main', '/assets/css/buy-page.css', ['media' => 'all', 'priority' => 9]);
        $this->registerStylesheet('products-custom', '/assets/css/products-custom.css', ['media' => 'all', 'priority' => 8]);
        $this->registerStylesheet('sesion-usuario', '/assets/css/sesion-usuario.css', ['media' => 'all', 'priority' => 10]);
        $this->registerStylesheet('sesion-adress', '/assets/css/sesion-adress.css', ['media' => 'all', 'priority' => 11]);
        $this->registerStylesheet('subcategory-main', '/assets/css/subcategory-main.css', ['media' => 'all', 'priority' => 12]);
        $this->registerStylesheet('theme-custom', '/assets/css/custom.css', ['media' => 'all', 'priority' => 1000]);
        $this->registerStylesheet('fotorama-custom', '/assets/css/fotorama.css', ['media' => 'all', 'priority' => 999]);
        ...
        $this->registerJavascript('buyjs', '/assets/js/buy-page.js', ['position' => 'bottom', 'priority' => 1]);
        $this->registerJavascript('usuario-sesion', '/assets/js/usuario-sesion.js', ['position' => 'bottom', 'priority' => 2]);
        $this->registerJavascript('theme-main', '/assets/js/theme.js', ['position' => 'bottom', 'priority' => 50]);
        $this->registerJavascript('fotorama-custom', '/assets/js/fotorama.js', ['position' => 'bottom', 'priority' => 995]);
        $this->registerJavascript('quagga-custom', '/assets/js/quagga.min.js', ['position' => 'bottom', 'priority' => 996]);
        $this->registerJavascript('live_w_locator-custom', '/assets/js/live_w_locator.js', ['position' => 'bottom', 'priority' => 997]);
        $this->registerJavascript('theme-custom', '/assets/js/custom.js', ['position' => 'bottom', 'priority' => 998]);
        $this->registerJavascript('adapter-latest', '/assets/js/adapter-latest.js', ['position' => 'bottom', 'priority' => 999]);
